...
# Training
- The project has two different agents: a trained with the distance of the agent until the goal (costumer or package; 6 observation space size) and other trained without it (5 observation space size).
