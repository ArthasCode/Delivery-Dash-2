...
# Training
- The project has three different agents: a trained with closest target observations (costumer or package; 6 space size observation), other trained without it (4 space size observation) and other with less sensors observations (along the best results).
